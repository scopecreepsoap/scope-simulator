...
import styles from './PlateQuadrantSelectorDiagram.module.css'
...
export const PlateQuadrantSelectorDiagram: React.FC<DiagramProps> = ({ initialValue, onAnswerChange, mode }) => {
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.dialogBox}>
                ...
                {/* Selected plate in the center */}
                <div className={styles.selectedPlateContainer}>
                    <motion.div 
                        className={styles.selectedPlate}
                        animate={{
                            boxShadow: [
                                "0 0 0 2px rgba(0, 150, 255, 0.8)",
